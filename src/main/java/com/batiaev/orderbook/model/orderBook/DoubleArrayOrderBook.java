...
public final class DoubleArrayOrderBook implements OrderBook {
    ...
    public DoubleArrayOrderBook(TradingVenue venue, ProductId productId, Instant lastUpdate, double[][] asks, double[][] bids, int depth) {
        this.venue = venue;
    ...
    public static DoubleArrayOrderBook orderBook(OrderBookSnapshotEvent snapshot, int depth) {
        return new DoubleArrayOrderBook(snapshot.tradingVenue(), snapshot.productId(), now(), snapshot.bids(), snapshot.asks(), depth);
    }
...
//        priceLevels();
    ...
    public boolean equals(Object obj) {
        ...
        var that = (DoubleArrayOrderBook) obj;
